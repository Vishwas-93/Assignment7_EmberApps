...
define("ember-quickstart/templates/scientists", ["exports"], function (exports) {
  ...
  exports.default = Ember.HTMLBars.template({ "id": "SFk7JuUy", "block": "{\"symbols\":[],\"statements\":[[1,[25,\"people-list\",null,[[\"title\",\"people\"],[\"List of Scientists\",[20,[\"model\"]]]]],false],[0,\"\\n\"]],\"hasEval\":false}", "meta": { "moduleName": "ember-quickstart/templates/scientists.hbs" } });
});
...
if (!runningTests) {
  require("ember-quickstart/app")["default"].create({"name":"ember-quickstart","version":"0.0.0+94934d8c"});
}
